...
class MBNS_MW1M_SlpSz50_3_18MCH extends MBNS_MW350K_SlpSz30_3_18MCH {
...
class MultiBonus_SlpSz50_MW1M extends MBNS_MW1M_SlpSz50_3_14MCH_NO_VAT{
    ...
    is_odd_bonus_eligible=()=>{
        if (this.match_count < this.get_min_bonus_eligble_match_count()) return false
    ...
    class MBNS_MW1M_SlipSize50_3_18MCH extends MBNS_MW350K_SlpSz50_3_18MCH{
    ...
    class MBNS_MW1M_25SLP_6_25MCH extends MBNS_MW500K_25SLP_6_38MCH{
    ...
    class MBNS_MW1M_SlpSz50_3_20MCH extends MBNS_MW350K_SlpSz50_3_18MCH{
    ...
    class MBNS_MaxWin1M_50SLP_3_40MCH_10P_VAT_WIN extends MBNS_MW350K_SlpSz50_3_18MCH {  
    ...
    class MBNS2_MW350K_55SLP_6_38MCH extends MBNS_MW350K_55SLP_6_38MCH{
    ...
    get_configurations=(configuration_name)=>{
        ...
        get_percentages = (match_count) => {
            if (match_count < 6) return 0
            let count = match_count > 38 ? 38 : match_count
            return {
                38: 3.00,
                32: 2.50,
                28: 2.00,
    ...
    class MBNS_HG_MW1M_SlpSz50_3_14MCH extends MBNS2_MW350K_55SLP_6_38MCH{
    get_configurations=( configuration_name)=>{
        let all_configurations = this.get_all_configurations()
        all_configurations['NET_PAY_CAP'] = 1000000
        all_configurations['BET_SLIP_BONUS'] = true
...
class MBNS_MaxWin1M_25SLP_6_38MCH extends MBNS_MW500K_25SLP_6_38MCH {
    get_configurations=(configuration_name)=>{
        let all_configurations = this.get_all_configurations()
        all_configurations['MAX_WIN'] = 1000000
        all_configurations['NET_PAY_CAP'] = 1000000
...
class MBNS75K_MW1M_50SLP_1MILCAP_3_24MCH extends MBNS75K_MW1M_50SLP_1MILCAP_3_14MMCH {
    get_configurations=(configuration_name)=>{
    ...
    get_percentages=(match_count)=>{
        let count = match_count > 24 ? 24 : match_count
        return {
            1: 0.0,
            2: 0.0,
            3: 0.05,
...
class MBNS52K_MW1MCAP_50SLP extends MBNS75K_MW1M_50SLP_1MILCAP_3_24MCH {

    get_configurations(configuration_name) {
        let all_configurations = this.get_all_configurations()
        all_configurations["BET_SLIP_BONUS"] = true
        all_configurations["MAX_WIN"] = 1_000000
        all_configurations["NET_PAY_CAP"] = 1000000
        all_configurations["MAX_BONUS"] = 52000
        all_configurations["SLIP_SIZE"] = 50
        all_configurations["MIN_BONUS_ODD"] = 1.4
    ...
    get_percentages(match_count) {
        let count = match_count > 19 ? 19 : match_count
        return {
            1: 0,
            2: 0,
            3: 0.03,
...
class MBNS_MW1M_50SLP_3_40MCH_20P_PAYOUT_TAX extends MBNS52K_MW1MCAP_50SLP {
    get_configurations = (configuration_name) => {
        let all_configurations = this.get_all_configurations()
        all_configurations["MIN_BONUS_ODD"] = 1.2
        all_configurations["MAX_BONUS"] = 100000
        ...
        all_configurations["TAX_TYPE"] = 'vat'
        all_configurations["VAT_TAX"] = 0.1
        all_configurations["WIN_TAX"] = 0.2
...
class MBNS_MW1M_SIpSz50_MXBNS_100K extends MBNS_MW1M_SlpSz50_3_18MCH {
...
class MBNS_MW1M_SlpSz50_MXBNS_100K extends MBNS_MW1M_SlpSz50_3_18MCH {
    get_configurations = (configuration_name) => {
        let all_configurations = this.get_all_configurations()
        all_configurations['MAX_WIN'] = 1000000
        all_configurations['NET_PAY_CAP'] = 1000000
...
class MBNS30K_MW870K_28SLP_870KCAP_7_28MCH extends MBNS75K_MW1M_50SLP_1MILCAP_3_24MCH {
    ...
    get_configurations = (configuration_name) => {
        ...
        let all_configurations = this.get_all_configurations()
        all_configurations["BET_SLIP_BONUS"] = true
        all_configurations["MAX_WIN"] = 870000
        all_configurations["NET_PAY_CAP"] = 870000
        all_configurations["MAX_BONUS"] = 30000
        all_configurations["SLIP_SIZE"] = 28
        all_configurations["MIN_BONUS_ODD"] = 1.4
    ...
    get_percentages = (match_count) => {
        let count = match_count > 28 ? 28 : match_count
        return {
            1: 0.0,
            2: 0.0,
            3: 0.0,
...
export default {
    ...
    MBNS_MW1M_SlpSz50_3_18MCH:MBNS_MW1M_SlpSz50_3_18MCH,
    MultiBonus_SlpSz50_MW1M:MultiBonus_SlpSz50_MW1M,
    MBNS_MW1M_SlipSize50_3_18MCH:MBNS_MW1M_SlipSize50_3_18MCH,
    MBNS_MW1M_25SLP_6_25MCH:MBNS_MW1M_25SLP_6_25MCH,
    MBNS_MW1M_SlpSz50_3_20MCH:MBNS_MW1M_SlpSz50_3_20MCH,
    MBNS_MaxWin1M_50SLP_3_40MCH_10P_VAT_WIN:MBNS_MaxWin1M_50SLP_3_40MCH_10P_VAT_WIN,
    MBNS2_MW350K_55SLP_6_38MCH:MBNS2_MW350K_55SLP_6_38MCH,
    MBNS_HG_MW1M_SlpSz50_3_14MCH:MBNS_HG_MW1M_SlpSz50_3_14MCH,
    MBNS_MaxWin1M_25SLP_6_38MCH:MBNS_MaxWin1M_25SLP_6_38MCH,
